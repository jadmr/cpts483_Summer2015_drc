...
//********************************Deprecated Methods********************************
    ...
    MediationProcessVector* getMediationProcesses();
    void InsertMediationVector(MediationProcessVector* MediationProcesses);
    void LoadDatabase2(QString filename);
    bool CreateMediationTable2(const QString& mediation_table_name);
};
