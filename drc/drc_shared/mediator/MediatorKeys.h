...
///
// LOAD CLOSED - FEES DUE MEDIATIONS VECTOR
//
///
const QString MKEY_DOCK_REQUEST_CLOSED_FEES_DUE_MEDIATIONS = "MKEY_DOCK_REQUEST_CLOSED_FEES_DUE_MEDIATIONS";
const QString MKEY_BL_REQUEST_CLOSED_FEES_DUE_MEDIATIONS_DONE = "MKEY_BL_REQUEST_CLOSED_FEES_DUE_MEDIATIONS_DONE";
const QString MKEY_DB_REQUEST_CLOSED_FEES_DUE_MEDIATIONS_DONE = "MKEY_DB_REQUEST_CLOSED_FEES_DUE_MEDIATIONS_DONE";
